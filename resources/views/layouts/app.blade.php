    ...
    <div class="d-flex">
        ...
        <nav class="sidebar d-none d-lg-block" id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('products.*') && !request()->routeIs('products.low-stock') ? 'active' : '' }}" href="{{ route('products.index') }}">
                        <i class="bi bi-box-seam"></i>
                        Products
                    </a>
                </li>
        ...
        <main class="main-content flex-grow-1">
            ...
            <div class="collapse d-lg-none bg-dark" id="mobileSidebar">
                <ul class="nav flex-column py-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ route('products.low-stock') }}">
